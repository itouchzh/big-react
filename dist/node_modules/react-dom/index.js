(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["react-dom"] = factory());
	...
	const ChildDetection = 0b0001000;
	const MutationMask = Placement | Update | ChildDetection;
	...
	function creasteFiberFromElement(element) {
	...
	const appentInitialChild = (parent, child) => {
	    parent.appendChild(child);
	};
	const createTextInstance = (content) => {
	    return document.createTextNode(content);
	};
	const appendChildToContainer = appentInitialChild;
